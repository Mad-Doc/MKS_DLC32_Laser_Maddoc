...
// #define Z_MAX_LIMIT_PIN             GPIO_NUM_2  // Reassigned to physical pause button

// Physical pause (Feed Hold) input. Active when button shorts GPIO35 to GND.
#define CONTROL_FEED_HOLD_PIN       GPIO_NUM_35

// Debounce physical control buttons (pause/start/reset) to avoid false triggers.
...
// Trinamic UART drivers (TMC2209) — TXD=GPIO0, RXD=GPIO4, 115200 baud
...
#define DEFAULT_SPINDLE_FREQ        1000    // 1KHz (TTL laser)
