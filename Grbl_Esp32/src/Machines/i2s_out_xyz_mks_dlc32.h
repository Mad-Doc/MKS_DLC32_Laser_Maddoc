...
#ifdef USE_BOARD_V2_0
// GPIO22 is reused for air assist output (M8/M9).
// PROBE is intentionally disabled on V2.0 for this wiring.
#else
...
// Air assist output on dedicated GPIO22 (M8/M9).
...
#define DEFAULT_LASER_MODE 1 // true - Mode laser activé par défaut
