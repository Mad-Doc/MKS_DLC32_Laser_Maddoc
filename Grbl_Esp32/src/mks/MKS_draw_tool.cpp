...
LV_IMG_DECLARE(SP_GRBL);

static void event_btn_tool_grbl(lv_obj_t* obj, lv_event_t event) {
...
void mks_draw_tool(void) {
    ...
    tool_img_grbl = lv_imgbtn_creat_mks(mks_global.mks_src_1, tool_img_grbl, &SP_GRBL, &SP_GRBL, LV_ALIGN_IN_RIGHT_MID, -180, -15, event_btn_tool_grbl);
    ...
    label_tool_grbl = lv_label_create(mks_global.mks_src_1, NULL);
    lv_label_set_recolor(label_tool_grbl, true);
    lv_label_set_text(label_tool_grbl, "GRBL");
    lv_obj_align(label_tool_grbl, tool_img_grbl, LV_ALIGN_IN_BOTTOM_MID, 0, 24);
    label_for_imgbtn_name(mks_global.mks_src_1, label_tool_language, tool_img_language, 0, 0, "Langue");
