...
typedef struct {
    ...
    const char *grbl_settings_title;

    /* Aperçu */
    const char *preview_title;
    const char *preview_wait;
    const char *preview_close;
    const char *preview_err_no_laser;
    const char *preview_err_memory;
    const char *preview_err_sd;
    const char *preview_err_open;
    const char *preview_err_render;
}mc_lg_muilt_t;
